...
echo ======================================================================================================
echo Export XML IO data from the KonaKart database using the KK Engine
echo ======================================================================================================

"%JAVA_HOME%/bin/java" -Xmx512m -cp %IMP_EXP_CLASSPATH% com.konakart.importer.xml.Xml_io -o -r %8\%2 -m %1 -s %2 -c %3 -ps %4 -cas %5 -usr %6 -pwd %7
