...
rem %9 = web service URL eg: http://localhost:8780/konakartadmin/services/KKWSAdmin
rem
...
echo ======================================================================================================
echo Export XML IO data from the KonaKart database using a SOAP service
echo ======================================================================================================

"%JAVA_HOME%/bin/java" -Xmx512m -cp %IMP_EXP_CLASSPATH% com.konakart.importer.xml.Xml_io -o -r %8\%2 -soap -m %1 -s %2 -c %3 -ps %4 -cas %5 -usr %6 -pwd %7 -ws %9
