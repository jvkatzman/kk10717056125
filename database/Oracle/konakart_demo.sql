...
-- 
-- -----------------------------------------------------------
-- KonaKart v7.1.1.1 demo database script for Oracle
-- Created: Thu Sep 12 06:01:41 BST 2013
-- -----------------------------------------------------------
-- 
set escape \
...
DROP TABLE address_format CASCADE CONSTRAINTS;
...
DROP TABLE banners_history CASCADE CONSTRAINTS;
...
DROP TABLE configuration_group CASCADE CONSTRAINTS;
CREATE TABLE configuration_group (
  configuration_group_id NUMBER(10,0) NOT NULL,
  configuration_group_title VARCHAR2(64) NOT NULL,
  configuration_group_descriptio VARCHAR2(255) NOT NULL,
  sort_order NUMBER(10,0) NULL,
...
DROP TABLE counter_history CASCADE CONSTRAINTS;
...
DROP TABLE customers_basket_attribute CASCADE CONSTRAINTS;
CREATE TABLE customers_basket_attribute (
...
DROP SEQUENCE customers_basket_attribute_SEQ;
CREATE SEQUENCE customers_basket_attribute_SEQ INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER;

DROP TABLE customers_info CASCADE CONSTRAINTS;
CREATE TABLE customers_info (
  customers_info_id NUMBER(10,0) NOT NULL,
  customers_info_date_of_last_lo TIMESTAMP,
  customers_info_number_of_logon NUMBER(10,0),
  customers_info_date_account_cr TIMESTAMP,
  customers_info_date_account_la TIMESTAMP,
...
DROP TABLE newsletters CASCADE CONSTRAINTS;
...
DROP TABLE products_attributes_downlo CASCADE CONSTRAINTS;
CREATE TABLE products_attributes_downlo (
  products_attributes_id NUMBER(10,0) NOT NULL,
...
DROP SEQUENCE products_description_SEQ;
...
DROP TABLE products_options_values_to CASCADE CONSTRAINTS;
CREATE TABLE products_options_values_to (
  products_options_values_to_pro NUMBER(10,0) NOT NULL,
  products_options_id NUMBER(10,0) NOT NULL,
  products_options_values_id NUMBER(10,0) NOT NULL,
  PRIMARY KEY(products_options_values_to_pro)
);
DROP SEQUENCE products_options_values_to_SEQ;
CREATE SEQUENCE products_options_values_to_SEQ INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER;
...
DROP TABLE whos_online CASCADE CONSTRAINTS;
...
INSERT INTO categories VALUES (categories_seq.nextval, 'category_hardware.gif', '0', '1', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'category_software.gif', '0', '2', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'category_dvd_movies.gif', '0', '3', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_graphic_cards.gif', '1', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_printers.gif', '1', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_monitors.gif', '1', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_speakers.gif', '1', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_keyboards.gif', '1', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_mice.gif', '1', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_action.gif', '3', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_science_fiction.gif', '3', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_comedy.gif', '3', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_cartoons.gif', '3', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_thriller.gif', '3', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_drama.gif', '3', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_memory.gif', '1', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_cdrom_drives.gif', '1', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_simulation.gif', '2', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_action_games.gif', '2', '0', sysdate, null);
INSERT INTO categories VALUES (categories_seq.nextval, 'subcategory_strategy.gif', '2', '0', sysdate, null);
...
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Expected Sort Order', 'EXPECTED_PRODUCTS_SORT', 'desc', 'This is the sort order used in the expected products box.', '1', '8', 'tep_cfg_select_option(array(''asc'', ''desc''), ', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Expected Sort Field', 'EXPECTED_PRODUCTS_FIELD', 'date_expected', 'The column to sort by in the expected products box.', '1', '9', 'tep_cfg_select_option(array(''products_name'', ''date_expected''), ', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Switch To Default Language Currency', 'USE_DEFAULT_LANGUAGE_CURRENCY', 'false', 'Automatically switch to the language''s currency when it is changed', '1', '10', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Use Search-Engine Safe URLs (still in development)', 'SEARCH_ENGINE_FRIENDLY_URLS', 'false', 'Use search-engine safe urls for all site links', '1', '12', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);
...
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Allow Guest To Tell A Friend', 'ALLOW_GUEST_TO_TELL_A_FRIEND', 'false', 'Allow guests to tell a friend about a product', '1', '15', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Default Search Operator', 'ADVANCED_SEARCH_DEFAULT_OPERATOR', 'and', 'Default search operators', '1', '17', 'tep_cfg_select_option(array(''and'', ''or''), ', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Store Address and Phone', 'STORE_NAME_ADDRESS', 'Store Name\nAddress\nCountry\nPhone', 'This is the Store Name, Address and Phone used on printable documents and displayed online', '1', '18', 'tep_cfg_textarea(', sysdate);
...
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Tax Decimal Places', 'TAX_DECIMAL_PLACES', '0', 'Pad the tax value this amount of decimal places', '1', '20', sysdate);
...
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Credit Card Owner Name', 'CC_OWNER_MIN_LENGTH', '3', 'Minimum length of credit card owner name', '2', '12', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Credit Card Number', 'CC_NUMBER_MIN_LENGTH', '10', 'Minimum length of credit card number', '2', '13', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Review Text', 'REVIEW_TEXT_MIN_LENGTH', '50', 'Minimum length of review text', '2', '14', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Best Sellers', 'MIN_DISPLAY_BESTSELLERS', '1', 'Minimum number of best sellers to display', '2', '15', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Also Purchased', 'MIN_DISPLAY_ALSO_PURCHASED', '1', 'Minimum number of products to display in the ''This Customer Also Purchased'' box', '2', '16', sysdate);
...
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Page Links', 'MAX_DISPLAY_PAGE_LINKS', '5', 'Number of ''number'' links use for page-sets', '3', '3', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Special Products', 'MAX_DISPLAY_SPECIAL_PRODUCTS', '9', 'Maximum number of products on special to display', '3', '4', sysdate);
...
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Products Expected', 'MAX_DISPLAY_UPCOMING_PRODUCTS', '10', 'Maximum number of products expected to display', '3', '6', sysdate);
...
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Manufacturers Select Size', 'MAX_MANUFACTURERS_LIST', '1', 'Used in manufacturers box; when this value is ''1'' the classic drop-down list will be used for the manufacturers box. Otherwise, a list-box with the specified number of rows will be displayed.', '3', '7', sysdate);
...
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('New Products Listing', 'MAX_DISPLAY_PRODUCTS_NEW', '10', 'Maximum number of new products to display in new products page', '3', '14', sysdate);
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES (configuration_seq.nextval, 'Sort Order', 'MODULE_ORDER_TOTAL_TAX_SORT_ORDER', '3', 'Sort order of display.', '6', '2', sysdate);
...
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Default Order Status For New Orders', 'DEFAULT_ORDERS_STATUS_ID', '1', 'When a new order is created, this order status will be assigned to it.', '6', '0', sysdate);
...
-- 8
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Display Product Image', 'PRODUCT_LIST_IMAGE', '1', 'Do you want to display the Product Image?', '8', '1', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Display Product Manufaturer Name','PRODUCT_LIST_MANUFACTURER', '0', 'Do you want to display the Product Manufacturer Name?', '8', '2', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Display Product Model', 'PRODUCT_LIST_MODEL', '0', 'Do you want to display the Product Model?', '8', '3', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Display Product Name', 'PRODUCT_LIST_NAME', '2', 'Do you want to display the Product Name?', '8', '4', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Display Product Price', 'PRODUCT_LIST_PRICE', '3', 'Do you want to display the Product Price', '8', '5', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Display Product Quantity', 'PRODUCT_LIST_QUANTITY', '0', 'Do you want to display the Product Quantity?', '8', '6', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Display Product Weight', 'PRODUCT_LIST_WEIGHT', '0', 'Do you want to display the Product Weight?', '8', '7', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Display Buy Now column', 'PRODUCT_LIST_BUY_NOW', '4', 'Do you want to display the Buy Now column?', '8', '8', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Display Category/Manufacturer Filter (0=disable; 1=enable)', 'PRODUCT_LIST_FILTER', '1', 'Do you want to display the Category/Manufacturer Filter?', '8', '9', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Location of Prev/Next Navigation Bar (1-top, 2-bottom, 3-both)', 'PREV_NEXT_BAR_LOCATION', '2', 'Sets the location of the Prev/Next Navigation Bar (1-top, 2-bottom, 3-both)', '8', '10', sysdate);
...
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Log Destination', 'STORE_PAGE_PARSE_TIME_LOG', '/var/log/www/tep/page_parse_time.log', 'Directory and filename of the page parse time log', '10', '2', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Log Date Format', 'STORE_PARSE_DATE_TIME_FORMAT', '%d/%m/%Y %H:%M:%S', 'The date format', '10', '3', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display The Page Parse Time', 'DISPLAY_PAGE_PARSE_TIME', 'true', 'Display the page parse time (store page parse time must be enabled)', '10', '4', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Store Database Queries', 'STORE_DB_TRANSACTIONS', 'false', 'Store the database queries in the page parse time log (PHP4 only)', '10', '5', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);

-- 11
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Use Cache', 'USE_CACHE', 'false', 'Use caching features', '11', '1', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Cache Directory', 'DIR_FS_CACHE', '/tmp/', 'The directory where the cached files are saved', '11', '2', sysdate);

-- 12
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('E-Mail Transport Method', 'EMAIL_TRANSPORT', 'sendmail', 'Defines if this server uses a local connection to sendmail or uses an SMTP connection via TCP/IP. Servers running on Windows and MacOS should change this setting to SMTP.', '12', '1', 'tep_cfg_select_option(array(''sendmail'', ''smtp''),', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('E-Mail Linefeeds', 'EMAIL_LINEFEED', 'LF', 'Defines the character sequence used to separate mail headers.', '12', '2', 'tep_cfg_select_option(array(''LF'', ''CRLF''),', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Use MIME HTML When Sending Emails', 'EMAIL_USE_HTML', 'false', 'Send e-mails in HTML format', '12', '3', 'tep_cfg_select_option(array(''true'', ''false''),', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Verify E-Mail Addresses Through DNS', 'ENTRY_EMAIL_ADDRESS_CHECK', 'false', 'Verify e-mail address through a DNS server', '12', '4', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);
...
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Download by redirect', 'DOWNLOAD_BY_REDIRECT', 'false', 'Use browser redirection for download. Disable on non-Unix systems.', '13', '2', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Expiry delay (days)' ,'DOWNLOAD_MAX_DAYS', '7', 'Set number of days before the download link expires. 0 means no limit.', '13', '3', '', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Maximum number of downloads' ,'DOWNLOAD_MAX_COUNT', '5', 'Set the maximum number of downloads. 0 means no download authorized.', '13', '4', '', sysdate);
...
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Compression Level', 'GZIP_LEVEL', '5', 'Use this compression level 0-9 (0 = minimum, 9 = maximum).', '14', '2', sysdate);

-- 15
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Session Directory', 'SESSION_WRITE_DIRECTORY', '/tmp', 'If sessions are file based, store them in this directory.', '15', '1', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Force Cookie Use', 'SESSION_FORCE_COOKIE_USE', 'False', 'Force the use of sessions when cookies are only enabled.', '15', '2', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Check SSL Session ID', 'SESSION_CHECK_SSL_SESSION_ID', 'False', 'Validate the SSL_SESSION_ID on every secure HTTPS page request.', '15', '3', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Check User Agent', 'SESSION_CHECK_USER_AGENT', 'False', 'Validate the clients browser user agent on every page request.', '15', '4', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Check IP Address', 'SESSION_CHECK_IP_ADDRESS', 'False', 'Validate the clients IP address on every page request.', '15', '5', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);
--INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Prevent Spider Sessions', 'SESSION_BLOCK_SPIDERS', 'False', 'Prevent known spiders from starting a session.', '15', '6', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate);
...
INSERT INTO products_attributes_downlo VALUES (26, 'unreal.zip', 7, 3);
...
INSERT INTO products_options_values_to VALUES (products_options_values_to_seq.nextval,4,1);
INSERT INTO products_options_values_to VALUES (products_options_values_to_seq.nextval,4,2);
INSERT INTO products_options_values_to VALUES (products_options_values_to_seq.nextval,4,3);
INSERT INTO products_options_values_to VALUES (products_options_values_to_seq.nextval,4,4);
INSERT INTO products_options_values_to VALUES (products_options_values_to_seq.nextval,3,5);
INSERT INTO products_options_values_to VALUES (products_options_values_to_seq.nextval,3,6);
INSERT INTO products_options_values_to VALUES (products_options_values_to_seq.nextval,3,7);
INSERT INTO products_options_values_to VALUES (products_options_values_to_seq.nextval,3,8);
INSERT INTO products_options_values_to VALUES (products_options_values_to_seq.nextval,3,9);
...
-----------------------------------------------------------------
-- KonaKart supplementary v7.1.1.1 demo database script for MySQL database
-----------------------------------------------------------------
--
...
DROP TABLE ipn_history CASCADE CONSTRAINTS;
...
DROP TABLE promotion_to_manufacturer CASCADE CONSTRAINTS;
...
DROP TABLE promotion_to_product CASCADE CONSTRAINTS;
...
DROP TABLE promotion_to_category CASCADE CONSTRAINTS;
...
DROP TABLE promotion_to_customer CASCADE CONSTRAINTS;
...
DROP TABLE promotion_to_coupon CASCADE CONSTRAINTS;
...
DROP TABLE products_to_products CASCADE CONSTRAINTS;
...
DELETE FROM products_options_values_to WHERE products_options_id = 5;
INSERT INTO products_options_values_to (products_options_values_to_pro, products_options_id, products_options_values_id) VALUES (products_options_values_to_seq.nextval, 5, 10);
INSERT INTO products_options_values_to (products_options_values_to_pro, products_options_id, products_options_values_id) VALUES (products_options_values_to_seq.nextval, 5, 11);
INSERT INTO products_options_values_to (products_options_values_to_pro, products_options_id, products_options_values_id) VALUES (products_options_values_to_seq.nextval, 5, 12);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (categories_seq.nextval, 'category_gift.gif', 0, 4, sysdate, null);
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES (configuration_seq.nextval, 'Google Shopping Account Id', 'GOOGLE_DATA_ACCOUNT_ID', '', 'Account Id (obtain from Google) for populating Google Shopping with Product Information', '23', '3', sysdate);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (categories_seq.nextval, 'category_software.gif', '0', '3', sysdate, null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (categories_seq.nextval, 'category_electronics.gif', '0', '3', sysdate, null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (categories_seq.nextval, 'category_home_garden.gif', '0', '3', sysdate, null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (categories_seq.nextval, 'subcategory_cameras.gif', 23, 5, sysdate, null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (categories_seq.nextval, 'subcategory_tablets.gif', 23, 15, sysdate, null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (categories_seq.nextval, 'subcategory_phones.gif', 23, 10, sysdate, null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (categories_seq.nextval, 'subcategory_kitchen.gif', 24, 10, sysdate, null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (categories_seq.nextval, 'subcategory_clocks.gif', 24, 5, sysdate, null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (categories_seq.nextval, 'subcategory_lawnmowers.gif', 24, 15, sysdate, null);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (manufacturers_seq.nextval,'Acctim','manufacturer/actim.jpg', sysdate, null);
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES (configuration_seq.nextval, 'Google Product Link', 'GOOGLE_PRODUCT_LINK', 'SelectProd.action?prodId=', 'Added to the KonaKart base URL to form a link to a product that is sent to Google.  The ProductId is appended at the end.', '23', '105', sysdate);
...
INSERT INTO kk_config (kk_config_id, kk_config_key, kk_config_value, date_added) VALUES (kk_config_seq.nextval, 'HISTORY', '7.1.1.0 I', sysdate);
INSERT INTO kk_config (kk_config_id, kk_config_key, kk_config_value, date_added) VALUES (kk_config_seq.nextval, 'VERSION', '7.1.1.0 Oracle', sysdate);
