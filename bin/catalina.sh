...
# ---- New Relic switch automatically added to start command on 2013 Dec 03, 19:35:09
NR_JAR=/usr/local/konakart/newrelic/newrelic.jar; export NR_JAR
JAVA_OPTS="$JAVA_OPTS -javaagent:$NR_JAR"; export JAVA_OPTS

# ---- New Relic switch automatically added to start command on 2013 Dec 03, 19:45:02
NR_JAR=/usr/local/konakart/newrelic/newrelic.jar; export NR_JAR
JAVA_OPTS="$JAVA_OPTS -javaagent:$NR_JAR"; export JAVA_OPTS
