        ...
        AdminOrderIntegrationMgrInterface
{
     ...
     * and adds them to the status trail of the main order. If the <code>newStatus</code> is Delivered then we
     * look at the current status of all of the vendor orders to see whether they have all been
     * fully delivered. If this is the case then we set the status of the parent order to delivered
     * otherwise to partially delivered.
     * 
     * @param orderId
     */
    @SuppressWarnings("unused")
