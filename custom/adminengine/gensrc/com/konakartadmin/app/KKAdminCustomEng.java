...
protected KKAdminException manageThrowable(Throwable e)
{
    ...
    /**
     * Insert an array of AdminOrderStatusName objects. We use the same id for all of the items in
     * the array.
     * 
     * @param sessionId
     *            The session Id of the logged in user
     ...
     * @return returns the id of the last inserted AdminOrderStatusName objects
     * @throws KKAdminException
     */
     ...
     * order status you must use <code>updateOrderStatus()</code>.
     * <p>
