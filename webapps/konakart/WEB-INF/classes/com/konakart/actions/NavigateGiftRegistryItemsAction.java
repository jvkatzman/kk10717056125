                    ...
                    && kkAppEng.getWishListMgr().getCurrentWishListItems() != null)
            {
                ...
                for (int i = 0; i < length; i++)
                {
                    ...
                    if (wli != null && wli.getProduct() != null)
                    {
                    	...
                    	//jk changed 3/3/2014 - image
                    	
                    	ProductIf prod = wli.getProduct();
                    	prod.getCustom1Int();
                        ...
                        // Create a WishListUIItem
                    	  ...
                    	  WishListUIItem item = new WishListUIItem(wli.getId(), wli.getProduct()
                                  .getId(), wli.getProduct().getName(), 
                                  
                                  kkAppEng.getProdImageBase(wli.getProduct()).replaceAll("null", "")+"300/300/" + prod.getCustom1Int() + ".jpg",
                      ...
                      /*  WishListUIItem item = new WishListUIItem(wli.getId(), wli.getProduct()
                                ...
                                .getProduct())
                                + "_1_small"
                                + kkAppEng.getProdImageExtension(wli.getProduct()),
                                wli.getFinalPriceExTax(), wli.getFinalPriceIncTax(),
                                wli.getPriority(), wli.getQuantityDesired(),
                                wli.getQuantityReceived(), wli.getComments());*/
