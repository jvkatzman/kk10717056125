...
public class ProdTileTag extends BaseTag
{
    ...
    public void renderTag(StringBuffer sb) throws JspException, KKAppException
    {
        ...
        } else
        {
            ...
            if (eng.isWishListEnabled())
            {
            	...
            	/*//jk changed 2/28/2014
            	 * String imgBase = eng.getImageBase();
            	 */               
            	String imgBase = eng.getLocalImageBase();
    ...
    private void getImageLink(StringBuffer sb, String size)
    {
        ...
        String imgBase = eng.getImageBase();  // "https://content.etilize.com/images/"; // eng.getProdImageBase(prod);
        ...
        //jk changed 2/18/2014 ie - src="http://localhost:8780/konakart/images/300/300/1016801019" 
        //sb.append(getImg(null, imgBase + "_1_" + size + eng.getProdImageExtension(prod),       
        size = "150/150/";
        sb.append(getImg(null, imgBase + size + prod.getCustom1Int() + ".jpg",
                prod.getName(), /* addBase */
                false));
        sb.append(END_A);
    }
